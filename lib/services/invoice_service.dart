...
class InvoiceService {
  ...
  ///
  /// ตั้ง `invoice_id` เหมือนข้อความแจ้งรับ/ปฏิเสธชำระและยกเลิกบิล — ฝั่งผู้เช่า
  /// ใช้คอลัมน์นี้รู้ว่าข้อความเกี่ยวกับบิล แล้วโหลดหน้าหลัก/แท็บบิลใหม่ · แชทวาด
  /// การ์ดตาม `message_type` เท่านั้น ข้อความนี้จึงยังแสดงเป็นข้อความธรรมดา
  ///
